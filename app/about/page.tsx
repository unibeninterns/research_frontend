    ...
    <>
      ...
      <section className="relative flex h-[100dvh] w-full items-center border bg-[linear-gradient(90deg,rgba(47,20,50,0.8),rgba(45,17,43,0.8),rgba(43,13,36,0.8),rgba(52,29,65,0.85))] lg:p-25">
        ...
        <div className="mt-5 w-full text-white lg:w-3/5">
          ...
          <p className="mt-[21px] text-lg leading-none lg:text-[18px]">
      ...
      <section className="flex h-screen w-full place-items-center bg-[#FBEFFF] lg:px-25">
        <div className="flex w-full flex-col justify-start gap-21 md:flex-row lg:mt-20">
          <div className="md:w-1/2">
            <h2 className="mb-5 text-[18px] font-bold md:text-3xl lg:text-[42px]">
              The DRID Learning
              <br />
              Experience
            </h2>
          ...
          <div className="relative z-5 mt-5 h-80 w-full self-center md:mt-0 md:w-2/5 lg:h-120 lg:w-88">
            <Image
              ...
              alt="Students learning from a laptop screen"
              className="absolute z-[-5] h-full w-full rounded-[25px] object-cover"
              // height={472}
              // width={352}
            />
            <div className="absolute h-full w-full rounded-[25px] bg-[linear-gradient(0deg,#250B2780,#85288D33)]" />
          </div>
        </div>
      </section>
      <section className="flex h-screen w-full place-items-center bg-[#FBEFFF] lg:px-25">
        <div className="">
          <h2 className="my-4 mb-5 text-2xl leading-none font-bold md:text-3xl lg:text-[42px]">
            The DRID Diploma in a Nutshell
          </h2>
          <div className="mt-7 grid w-full grid-cols-1 gap-2 md:grid-cols-2 md:gap-4 lg:grid-cols-3 lg:gap-8">
            {nutshell.map((n) => (
              <div
                key={n.title}
      ...
      <section className="min-h-screen w-full bg-white px-2 py-10 md:px-4 lg:px-[100px]">
        ...
        <div className="mx-auto grid max-w-6xl grid-cols-1 gap-2 sm:grid-cols-2 md:gap-4 lg:mt-10 lg:mb-16 lg:gap-6">
          <style jsx>{`
          ...
          {weeks.map((week, index) => (
            <div
              key={week.title}
              className="flex w-full items-start gap-2 rounded-xl bg-[#FBEFFF40] p-2 shadow-sm transition-shadow duration-300 hover:shadow-md md:gap-2 lg:p-4"
            >
      ...
      <section className="flex min-h-screen w-full flex-col items-center bg-[#FEFBFF] lg:px-25 lg:pb-15">
      ...
      <section className="min-h-screen w-full bg-[#FEFBFF] py-5 lg:px-25 lg:py-20">
        ...
        <div className="mt-10 flex w-full flex-col justify-center md:flex-row md:items-start">
      ...
      <section className="flex flex-col items-center justify-start bg-[#FEFBFF] lg:py-25">
        ...
        <p className="mt-3 text-center text-sm md:text-xl">
