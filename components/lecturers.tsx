...
const Lecturer = ({
  ...
  return (
    <>
      <div
        onClick={show}
        className='h-[95%] w-[270px] rounded-[10px] m-2 p-3 flex flex-col bg-[rgba(251,239,255,0.5)] shadow-[4px_4px_6px_-3px_rgba(160,32,240,0.25)]  transition duration-500 ease-in-out transform hover:scale-105 overflow-hidden hover:border-[#800080] hover:border-1'
      >
        <img
          src={`/lecturers/${image}`}
          alt={name}
      ...
      <div
        className={`fixed inset-0 z-[9999] top-0 left-0 w-screen h-screen bg-[rgba(0,0,0,0.0.8)] ${showInfo} flex items-center justify-center p-2`}
      >
        <div className='lg:w-[864px] max-h-[800px] bg-[rgba(255,255,255,1)] border-[rgba(186,184,184,1)] rounded-[15px] flex flex-col items-center justify-center lg:py-4 border-2'>
          <div className=' flex flex-row md:gap-3 w-full justify-center'>
    ...
    <>
      <div className='mt-5 h-auto w-full p-2'>
        <div className='mt-3 p-1 relative flex flex-row items-center justify-center gap-2'>
          <button
            onClick={scrollLeft}
            className='z-10 p-1 rounded-full shadow-[4px_4px_6px_-3px_rgba(160,32,240,0.25)] border-1 border-[rgba(160,32,240,0.25)] cursor-pointer bg-white transition duration-150 ease-in transform hover:scale-110'
          >
          ...
          <div
            ref={scrollRef}
            className='flex flex-row overflow-x-auto flex-nowrap justify-around scroll-smooth h-full grow-1 w-full p-2 md:px-8 scrollbar-hide'
          >
