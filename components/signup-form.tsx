      ...
      <CardContent className="flex flex-1 flex-col p-8">
        ...
        <div className="flex flex-1 flex-col justify-center space-y-6">
          ...
          <div className="mb-4">
            <div className="relative">
              ...
              <Input
                ...
                className={`h-12 w-full border pl-10 ${
          ...
          <div className="mb-4">
            <div className="relative">
              <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                <PadlockSignUp className="h-5 w-5 text-gray-400" />
              </div>
              <Input
                ...
                className={`h-12 pr-20 pl-10 ${errors.password ? "border-red-300" : "border-gray-200"} focus:border-purple-600 focus:ring-purple-600`}
              />
              <button
                type="button"
          ...
          <div className="flex items-start space-x-3">
            <Checkbox
              ...
              className={`mt-1 data-[state=checked]:border-purple-600 data-[state=checked]:bg-[#800080] ${errors.agreeToTerms ? "border-red-300" : ""}`}
            />
            <label
              htmlFor="terms"
